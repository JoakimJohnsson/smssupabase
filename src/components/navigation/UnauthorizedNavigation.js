    ...
    return (
        <nav className="flex items-center justify-between flex-wrap p-6">
            ...
            <div className="flex items-center flex-shrink-0 lg:hidden">
                <button className="flex items-center px-3 py-2 hover:opacity-70" onClick={() => setIsOpen(!isOpen)}>
            ...
            <div className={
                ...
                <div className="text-sm lg:flex-grow">
                    <Link to="/" className="block mt-4 lg:inline-block lg:mt-0 hover:opacity-70 mr-4">Start</Link>
                    <Link to="/login" className="block mt-4 lg:inline-block lg:mt-0 hover:opacity-70 mr-4">Login</Link>
                    <Link to="/signup" className="block mt-4 lg:inline-block lg:mt-0 hover:opacity-70 mr-4">Signup</Link>
                </div>
            </div>
        </nav>
    )

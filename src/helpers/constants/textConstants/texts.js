...
export const TEXTS = {
    ...
    ADMIN_INFO_2: "För frågor, support och förslag på kommande funktioner - maila Super-Admin. Eller använd den inbyggda meddelandefunktionen.",
...
export const PANES = {
    TITLES: {
        ...
        SHORT_NAME: "Titlar",
        COLLECTING_CHECK_GRADING_STATUS_OPEN_1: "Klicka här för att beräkna värdet och kontrollera om något exemplar av",
